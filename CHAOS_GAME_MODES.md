...
- Starting health is reduced by 50%, rounded up.
- Queued garbage falls one-by-one.
- Garbage margin will be 50 pieces versus the normal 30.
...
- Margin time for queued garbage is stretched across 5 minutes.
- Garbage margin is 30 pieces.
## __Chaos Mode__
It's back baby! This mode is similar to Modern, but with a few key differences:
- The player can send unconventional garbage. *If you know, then you know.* :smirk:
- All combo garbage will cascade.
- Garbage margin will be 20 pieces versus the normal 30.
## __Hard Mode__
I'm definitely keeping this as it drastically changes gameplay dynamics in a good way.
- There will be no stop time for combos or chains.
- Starting health is increased by 50%, rounded down.
- Queued garbage falls all at once.
- All combo garbage will cascade.
## Insane Mode
Hard Mode doesn't challenge you enough? This may suit your taste. :stuck_out_tongue:
- There will be no stop time for combos or chains.
