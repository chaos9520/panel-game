...
modern[3] = LevelData()
modern[3] :setStartingSpeed(26)
          :setSpeedIncreaseMode(LevelData.SPEED_INCREASE_MODES.TIME_INTERVAL)
          :setShockFrequency(28)
          :setShockCap(12)
          :setColorCount(5)
          :setMaxHealth(92)
          :setGarbageMargin(21)
...
modern[7] = LevelData()
modern[7] :setStartingSpeed(77)
          :setSpeedIncreaseMode(LevelData.SPEED_INCREASE_MODES.TIME_INTERVAL)
          :setShockFrequency(34)
          :setShockCap(8)
          :setColorCount(5)
          :setMaxHealth(38)
          :setGarbageMargin(26)
...
modern[9] = LevelData()
modern[9] :setStartingSpeed(90)
          :setSpeedIncreaseMode(LevelData.SPEED_INCREASE_MODES.TIME_INTERVAL)
          :setShockFrequency(38)
          :setShockCap(7)
          :setColorCount(5)
          :setMaxHealth(24)
          :setGarbageMargin(29)
...
modern[12] = LevelData()
modern[12]:setStartingSpeed(48)
          :setSpeedIncreaseMode(LevelData.SPEED_INCREASE_MODES.TIME_INTERVAL)
          :setShockFrequency(24)
          :setShockCap(15)
          :setColorCount(5)
          :setMaxHealth(1)
          :setGarbageMargin(15)
...
modern[15] = LevelData()
modern[15]:setStartingSpeed(92)
          :setSpeedIncreaseMode(LevelData.SPEED_INCREASE_MODES.TIME_INTERVAL)
          :setShockFrequency(42)
          :setShockCap(6)
          :setColorCount(7)
          :setMaxHealth(1)
          :setGarbageMargin(33)
...
classic[1]:setStartingSpeed(1)
          ...
          :setStopComboConstant(0)
          :setStopChainConstant(0)
          :setStopDangerConstant(0)
