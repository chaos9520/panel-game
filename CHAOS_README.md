...
- The formula for stop time and stack rise speed have been changed. Fair warning, 97 speed is where the fun begins. :smirk:
### PvP Changes
...
- 3-wides will cascade instead of fall left and right.
...
## Other Changes
- Challenge Mode has been completely revamped. All +4s do damage, and chain garbage is capped at 12 damage. View the changes here: https://github.com/chaos9520/panel-game/blob/chaos_build/CHAOS_CHALLENGE_MODE.md
